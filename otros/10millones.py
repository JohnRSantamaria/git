...
def generar_datos(total):
    ...
    for _ in range(total):
        # Elegir aleatoriamente tipo_cap, uc y subcuenta
        ...
        nuevo_registro = {
            ...
            "SUBCUENTA": str(subcuenta),  # Asegurarse de que SUBCUENTA sea string
...
# Generar los datos
f459_variado = generar_datos(total_registros)
